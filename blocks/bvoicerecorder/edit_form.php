...
class block_bvoicerecorder_edit_form extends block_edit_form {
    protected function WIMBA_specific_definition($mform) {
        ...
        $mform->WIMBA_setType('config_text', PARAM_RAW); // XSS is prevented when printing the block contents and serving files
    }
}
