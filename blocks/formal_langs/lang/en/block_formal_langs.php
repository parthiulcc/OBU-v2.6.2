...
$string['lang_cpp_parseable_language'] =  'C++ programming language with parsing capability';
$string['lang_cpp_parseable_language_help'] = 'C++ programming language with parsing capability';
