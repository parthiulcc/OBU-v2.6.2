...
/**
 * Script to handle upgrades on the plugin
 *
...
/**
 * Function called by Moodle API on upgrading of the plugin
 *
 * @param int $oldversion the previous version of the plugin
 * @return bool A status indicating success or failure
 */
function xmldb_repository_cla_survey_upgrade($oldversion) {
    return true;
}
