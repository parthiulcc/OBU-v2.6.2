...
/**
 * Testing the upgrade of vmatch question attempts.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmatch_attempt_upgrader_test extends question_attempt_upgrader_test_base {

    public function test_vmatch_deferredfeedback_history6220() {
        $quiz = (object) array(
            'id' => '72',
            'course' => '1181',
    ...
    public function test_vmatch_deferredfeedback_history60() {
        $quiz = (object) array(
            'id' => '60',
            'course' => '2304',
    ...
    public function test_vmatch_deferredfeedback_history622220() {
        $quiz = (object) array(
            'id' => '719',
            'course' => '3541',
