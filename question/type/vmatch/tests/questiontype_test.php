...
require_once($CFG->dirroot . '/question/type/vmatch/questiontype.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmatch_test extends advanced_testcase {
    /** @var qtype_vmatch instance of the question type class to test. */
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_vmatch();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'vmatch');
    }
