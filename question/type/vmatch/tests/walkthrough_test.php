...
/**
 * Unit tests for the vmatching question type.
 *
 * @copyright  2010 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_vmatch_walkthrough_test extends qbehaviour_walkthrough_test_base {

    public function test_deferred_feedback_unanswered() {

        // Create a vmatching question.
        $m = test_question_maker::make_a_vmatching_question();
    ...
    public function test_vmatch_with_tricky_html_choices() {
    ...
    public function test_vmatch_clear_wrong() {
