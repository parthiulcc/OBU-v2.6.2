...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			WIRISplugins_js = "core/WIRISplugins.js";
			tech = s.split("#")[0].trim();
		    if (tech=="php") {
				_wrs_int_conf_file_override = "integration/loadconfig.php";
			} else if (tech=="aspx") {
				_wrs_int_conf_file_override = "integration/configurationjs.aspx";
