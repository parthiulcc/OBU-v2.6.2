    ...
    */    
    function WIMBA_getVTPrincipalView($message,$type=null) {
        ...
        $this->xml->WIMBA_addButtonElement(
                        ...
                        "disabled",
                        "launch",
                        get_string('toolbar_launch', 'voiceauthoring'),
                        "javascript:WIMBA_LaunchElement('manageAction.php','voiceauthoring');");
        ...
        if($this->session->WIMBA_isInstructor())
        {
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "disabled",
                            'activities',
                            get_string('toolbar_activity', 'voiceauthoring'),
                            "WIMBA_doOpenAddActivity('../../course/mod.php','section=0&sesskey=" . sesskey() . "&add=voiceauthoring')");
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "enabled",
                            "new",
                            get_string('toolbar_new', 'voiceauthoring'),
                            "javascript:loadNewSettings('generateXmlSettingsPanel.php','create','voicetools' ,'recorder','all','false')");
            ...
            if(WIMBA_isGradebookAvailable() && isset($type) && $type == "board"){
              $this->xml->WIMBA_addButtonElement(
                              ...
                              "disabled",
                              "grade",
                              get_string('toolbar_grade', 'voiceauthoring'),
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "disabled",
                            "settings",
                            get_string('toolbar_settings', 'voiceauthoring'),
                            "javascript:WIMBA_editSettings('generateXmlSettingsPanel.php','all');");
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "disabled",
                            "delete",
                            get_string('toolbar_delete', 'voiceauthoring'),
                            "javascript:WIMBA_deleteResource('manageAction.php');");
        ...
        if (is_array($resources)) 
        {
            $this->xml->WIMBA_addProduct(
                            ...
                            "board",
                            $resources,
                            get_string('list_no_voiceauthorings', 'voiceauthoring'));
        }
        else 
        {//problem to get the vt resource
            wimba_add_log(WIMBA_INFO,voiceauthoring_LOGS,"No resource have been created yet");  
            $this->xml->WIMBA_setError(get_string("error_connection_vt", "voiceauthoring"));
        }
    ...
    function WIMBA_getVTSettingsView($update) {
         ...
         *********/
         ...
         {
            $this->xml->WIMBA_addContextBarElement(
                            get_string("contextbar_settings", 'voiceauthoring'),
                            get_string("general_" . $this->product, 'voiceauthoring'),
         ...
         else
         {
            $this->xml->WIMBA_addContextBarElement(
                            get_string("contextbar_settings", 'voiceauthoring'),
                            get_string("general_" . $this->product, 'voiceauthoring'),
                            get_string("contextbar_new_" . $this->product, 'voiceauthoring'),
                            "");
         }
        ...
        $this->xml->WIMBA_createValidationButtonElement(
                        get_string("validationElement_cancel", 'voiceauthoring'),
                        "link",
                        "javascript:launchAjaxRequest('generateXmlMainPanel.php','',true,'all')",
                        "setting_Cancel");
        ...
        {
            $this->xml->WIMBA_createValidationButtonElement(
                            get_string("validationElement_create", 'voiceauthoring'),
                            "submit",
        ...
        {
            $this->xml->WIMBA_createValidationButtonElement(
                            get_string("validationElement_saveAll", 'voiceauthoring'),
                            "submit",
...
* ***********************************/
    ...
    */ 
    function WIMBA_createGeneralInfoPanelStart($update) {
        ...
        $this->xml->WIMBA_addCustomLineElement(
                        "*",
                        "required", 
                        get_string('title', 'voiceauthoring'),
                        array ("class" => "LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_required", 'voiceauthoring'));

        $this->xml->WIMBA_createLine();
        
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('description', 'voiceauthoring'),
                         array ("class" => "LargeLabel_Width TextRegular_Right"));
    ...
    */ 
    function WIMBA_createVBInfoPanel() {
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('type', 'voiceauthoring'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_thread', 'voiceauthoring'));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private', 'voiceauthoring'), 
                        array ("for" => "led_instructor","valign" => "top"));
        $this->xml->WIMBA_addSimpleLineElement("br", NULL);
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_comment', 'voiceauthoring'), 
                        array ("class" => "TextComment AlignRight"));
        
        $this->xml->WIMBA_createLine();
        
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_Info', 'voiceauthoring'), 
                        "block", 
                        "Info", 
                        "current", 
                        "all");
    ...
    */ 
    function WIMBA_createVPInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('comment_slide', 'voiceauthoring'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('private_slide', 'voiceauthoring'));
        $this->xml->WIMBA_createLine();

        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_slide_comment', 'voiceauthoring'), 
    ...
    */    
    function WIMBA_createPCInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", 
                                         get_string('post_podcast', 'voiceauthoring'));
    ...
    */ 
    function WIMBA_createVBVPMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement("label",
                                         get_string('audioquality', 'voiceauthoring'),
                                         array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_max_message", 'voiceauthoring'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_media', 'voiceauthoring'), 
                        "none", 
                        "Media", 
                        "", 
                        "all");
    ...
    */ 
    function WIMBA_createPCMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement(
                        "label",
                        get_string("settings_audio", 'voiceauthoring'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_auto_publish_podcast", 'voiceauthoring'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
    ...
    */     
    function WIMBA_createVBFeaturesPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('short_message', 'voiceauthoring'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('chrono_order', 'voiceauthoring'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('show_forward', 'voiceauthoring'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('settings_show_reply', 'voiceauthoring'));
        ...
        if(WIMBA_isGradebookAvailable()){
          ...
          if(isset ($this->currentObject)){
            $activities = $DB->get_records("voiceauthoring", array("rid" => $this->currentObject->WIMBA_getRid()));
            if(empty($activities)){
             $parameters['disabled'] = "true";
            }
          }else{
          ...
          $this->xml->WIMBA_addInputElement($parameters);
          $this->xml->WIMBA_addSimpleLineElement("label", get_string('grade_settings', 'voiceauthoring'));
          
          $this->xml->WIMBA_createLine("Padding_top_25px");
          
          $this->xml->WIMBA_addSimpleLineElement(
                          "label", 
                          get_string('points_possible', 'voiceauthoring'), 
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_features', 'voiceauthoring'),
                        "none", 
                        "Features", 
                        "",       
                        "all");
    ...
    */
    function WIMBA_createVTAccessPanel() {
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('available', 'voiceauthoring'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_date', 'voiceauthoring'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('end_date', 'voiceauthoring'), 
                        array ("for" => "end_date"));     
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('access', 'voiceauthoring'), 
                        "none", 
                        "Access", 
                        "", 
                        "all");
    ...
    */    
    function WIMBA_createOptionAudioSettings() {
        $option = array (
            "value" => "spx_8_q3",
            "display" => get_string('basicquality','voiceauthoring')
        );
        ...
        $option = array (
            "value" => "spx_16_q4",
            "display" => get_string('standardquality','voiceauthoring')
        );
        ...
        $option = array (
            "value" => "spx_16_q6",
            "display" => get_string('goodquality','voiceauthoring')
        );
        ...
        $option = array (
            "value" => "spx_32_q8",
            "display" => get_string('superiorquality','voiceauthoring')
        );
    ...
    */   
	...
	global $DB;
        $resources = array ();
        $list = voiceauthoring_get_voicetools_list($this->session->hparams["course_id"]);
        ...
        if( $list != false)
        {
            ...
            {
                wimba_add_log(WIMBA_ERROR,voiceauthoring_LOGS,"Problem to get the list of resources from the voiceauthoring_LOGS server"); 
                return false;
            }
            else
        ...
        {
            wimba_add_log(WIMBA_ERROR,voiceauthoring_LOGS,"Problem to get the list of resources from the databse");   
            return false;    
        }
        ...
        for ($i = 0; $i < count($ressources); $i++) 
        {
            ...
            if ( $voiceauthoring = $DB->get_records("voiceauthoring", array("rid" => $rid))) {
                 $activities = array();
                 foreach($voiceauthoring as $voicetool) {
                     array_push($activities, $voicetool->name);
                 }
                 $xmlResource->WIMBA_setLinkedActivities(implode("|",$activities));
            }
                                    
            $xmlResource->WIMBA_setTooltipAvailability(get_string("tooltipVT_" . $preview . "_student", 'voiceauthoring'));
