...
$sentence2 = "<a href='javascript:WIMBA_startVoiceTools()';>".get_string ('vtpopupshouldappear.2', 'voiceemail')."</a>";
...
$resource = $vtAction->WIMBA_getResource( $dbResource->rid ) ;  
...
$resource->WIMBA_setEmailFrom( $USER->email );
...
function WIMBA_startVoiceTools(){
