...
$string['modulename'] = 'Voice Podcaster';
$string['modulenameplural'] = 'Voice Podcasters';
$string['modulename_help'] = '<p>Blackboard Collaborate Voice Tools facilitate and promote vocal instruction, collaboration, coaching, and assessment -- perfect for language learning, and creating vocal exercises in any subject.</p><p>Four Voice Tools are available:</p><p>Voice Boards craft threaded voice discussions, public or private, lending a warm vocal component beyond traditional message boards.</p><p>Voice Presentations combine vocal and text-based commentary alongside a website or any other web-based content</p><p>Voice Podcaster simplifies the popular medium of podcasting with an easy-to-use recording interface, automatic feed creation, and 1-click subscription.</p><p>Voice Recorder embeds an audio announcement, recorded by instructors, directly in a course (Note: this tool is only available within a separate Voice Recorder Block)</p>';
$string['emptyAdminUsername'] = 'Admin user name is empty';
$string['emptyAdminPassword'] = 'Admin user password is empty';
$string['pluginadministration'] = 'Voice Podcaster administration';
$string['pluginname'] = 'Voice Podcaster';
...
$string['resourcereq'] = 'You must select a resource to associate with this Voice Podcaster';
...
$string["voicepodcastertype"]="Associated Voice Podcaster:";    
$string["activity_name"]="Activity Name:";      
$string["topicformat"]="Topic:";
$string["weeksformat"]="Week:";  
$string["activity_tools_not_available"]="The Voice Podcaster linked to this activity is currently unavailable.<br>Please contact your instructor";
...
$string['new_podcaster'] = 'New Voice Podcaster';   
//Validation Bar
...
$string['error_unconfigured_vt'] = "The Blackboard Collaborate Voice module has not been configured.  Please contact your administrator.";
...
$string['PodcasterDescription'] = "Creates a new Voice Podcaster";
...
$string['podcaster'] = 'Voice Podcaster';   
...
$string["podcasterCreated"]="Your Voice Podcaster has been successfully created.";
$string["podcasterUpdated"]="Your Voice Podcaster has been successfully updated.";
$string["deletePodcaster"] = "Your Voice Podcaster has been successfully deleted."; 
...
$string['error_notfind'] = "Invalid Wimba Classroom parameters. Please contact your administrator for more information.";
$string['error_room'] = "Invalid Wimba Classroom parameters. Please contact your administrator for more information.";
...
$string['choiceElement_description_room'] = "Creates a new Wimba Classroom";
...
$string['settings_enabled_guest_comment'] = "Note: This setting only has effect when guest access is enabled on the Wimba Classroom server.  
...
$string['settings_guest_access_comment'] = "Note: This setting only has effect when guest access is enabled on the Wimba Classroom server.Contact your administrator for more information.";
...
$string['configuration_lc'] = "Wimba Classroom Server Configuration";
$string['configuration_lc_server_url'] = "Wimba Classroom Server URL:";
$string['configuration_lc_version'] = "Wimba Classroom Version:";
...
$string['advancedPopup_sentence'] = "To access to the advanced settings, all the current settings for this Wimba Classroom will be saved";
...
$string['list_no_liveclassrooms'] = "There are no Wimba Classrooms available at this time";
$string['list_no_pcs'] = "There are no Voice Podcaster available at this time";
...
$string['settings_advanced_comment_1'] = "For advanced users only: Click on the buttons below to open Wimba Classroom 
...
$string["voicepodcaster:addinstance"] = "Add a new Voice Board activity";
$string["voicepodcaster:presenter"] = "Has presenter access to Voice Podcaster";
