...
$string['configuration_vt'] = "Configuration du Serveur Wimba Classroom";
$string['configuration_vt_server_url'] = "URl du serveur Wimba Classroom:";
$string['configuration_vt_version'] = "Version du serveur Wimba Classroom:";
...
$string['configuration_test_vtfailedConnection'] = "Please check the Wimba Classroom parameters and retry.";
$string['configuration_test_vt_failed_sentence_start'] = "The test of your Wimba Classroom server configuration settings was unsuccessful.";
$string['configuration_test_vt_successful_sentence'] = "The test of your Wimba Classroom server configuration settings was successful.
...
$string['error_connection_vt'] = "Moodle cannot connect to the Wimba Classroom server. Please reload the page or contact your administrator for more information.";
...
$string['PodcasterDescription'] = "Cr&eacute;er un nouveau Voice Podcaster";
