...
function WIMBA_doOpenAddActivity(url,param){
  if( !currentId.empty() ) {
...
WIMBA_addLoadEvent(WIMBA_display);
</script>
    ...
    <div class="wimba_box" id="downloadPopup"
      ...
      <div class="wimba_boxTop">
        <div class="wimbaBoxTopDiv">
          ...
          <span title="close" class="wimba_close_box" onclick="WIMBA_closePopup()">Close</span>
          ...
          <p style="height:20px;padding-top:10px;padding-left:20px">
            <a class="regular_btn" href="#" onclick="WIMBA_closePopup()" style="margin-left:70px;"><span
