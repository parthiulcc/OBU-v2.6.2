    ...
    function WIMBA_getVTPrincipalView($message,$type=null) {
        ...
        if($this->session->WIMBA_isInstructor())
        {
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "new",
                            get_string('toolbar_new', 'liveclassroom'),
                            "javascript:loadNewSettings('generateXmlSettingsPanel.php','create','voicetools' ,'lc','all','false')");
            ...
            if(WIMBA_isGradebookAvailable() && isset($type) && $type == "board"){
              $this->xml->WIMBA_addButtonElement(
                              ...
                              "disabled",
                              "grade",
                              get_string('toolbar_grade', 'liveclassroom'),
        ...
        {//problem to get the vt resource
            wimba_add_log(WIMBA_INFO,liveclassroom_LOGS,"No resource have been created yet");  
            $this->xml->WIMBA_setError(get_string("error_connection_vt", "liveclassroom"));
        }
...
* ***********************************/
    ...
    */ 
    function WIMBA_createGeneralInfoPanelStart($update) {
        ...
        $this->xml->WIMBA_addCustomLineElement(
                        "*",
                        "required", 
                        get_string('title', 'liveclassroom'),
                        array ("class" => "LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('description', 'liveclassroom'),
                         array ("class" => "LargeLabel_Width TextRegular_Right"));
    ...
    */ 
    function WIMBA_createVBInfoPanel() {
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_thread', 'liveclassroom'));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private', 'liveclassroom'), 
                        array ("for" => "led_instructor","valign" => "top"));
        $this->xml->WIMBA_addSimpleLineElement("br", NULL);
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_comment', 'liveclassroom'), 
                        array ("class" => "TextComment AlignRight"));
        
        $this->xml->WIMBA_createLine();
        
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_Info', 'liveclassroom'), 
                        "block", 
                        "Info", 
                        "current", 
                        "all");
    ...
    */ 
    function WIMBA_createVPInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('comment_slide', 'liveclassroom'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('private_slide', 'liveclassroom'));
        $this->xml->WIMBA_createLine();

        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_slide_comment', 'liveclassroom'), 
    ...
    */    
    function WIMBA_createPCInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", 
                                         get_string('post_podcast', 'liveclassroom'));
    ...
    */ 
    function WIMBA_createVBVPMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement("label",
                                         get_string('audioquality', 'liveclassroom'),
                                         array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_max_message", 'liveclassroom'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
    ...
    */ 
    function WIMBA_createPCMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement(
                        "label",
                        get_string("settings_audio", 'liveclassroom'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_auto_publish_podcast", 'liveclassroom'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
    ...
    */     
    function WIMBA_createVBFeaturesPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('short_message', 'liveclassroom'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('chrono_order', 'liveclassroom'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('show_forward', 'liveclassroom'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('settings_show_reply', 'liveclassroom'));
        ...
        if(WIMBA_isGradebookAvailable()){
          ...
          if(isset ($this->currentObject)){
            $activities = $DB->get_records("liveclassroom", array("rid" => $this->currentObject->WIMBA_getRid()));
            if(empty($activities)){
             $parameters['disabled'] = "true";
            }
          }else{
          ...
          $this->xml->WIMBA_addInputElement($parameters);
          $this->xml->WIMBA_addSimpleLineElement("label", get_string('grade_settings', 'liveclassroom'));
          
          $this->xml->WIMBA_createLine("Padding_top_25px");
          
          $this->xml->WIMBA_addSimpleLineElement(
                          "label", 
                          get_string('points_possible', 'liveclassroom'), 
    ...
    */
    function WIMBA_createVTAccessPanel() {
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('available', 'liveclassroom'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_date', 'liveclassroom'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('end_date', 'liveclassroom'), 
                        array ("for" => "end_date"));     
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('access', 'liveclassroom'), 
                        "none", 
                        "Access", 
                        "", 
                        "all");
    ...
    */    
    function WIMBA_createOptionAudioSettings() {
        $option = array (
            "value" => "spx_8_q3",
            "display" => get_string('basicquality','liveclassroom')
        );
        ...
        $option = array (
            "value" => "spx_16_q4",
            "display" => get_string('standardquality','liveclassroom')
        );
        ...
        $option = array (
            "value" => "spx_16_q6",
            "display" => get_string('goodquality','liveclassroom')
        );
        ...
        $option = array (
            "value" => "spx_32_q8",
            "display" => get_string('superiorquality','liveclassroom')
        );
    ...
    */   
	...
	global $DB;
        $resources = array ();
        $list = liveclassroom_get_voicetools_list($this->session->hparams["course_id"]);
        ...
        if( $list != false)
        {
            ...
            {
                wimba_add_log(WIMBA_ERROR,liveclassroom_LOGS,"Problem to get the list of resources from the liveclassroom_LOGS server"); 
                return false;
            }
            else
        ...
        {
            wimba_add_log(WIMBA_ERROR,liveclassroom_LOGS,"Problem to get the list of resources from the databse");   
            return false;    
        }
        ...
        for ($i = 0; $i < count($ressources); $i++) 
        {
            ...
            if ( $liveclassroom = $DB->get_records("liveclassroom", array("rid" => $rid))) {
                 $activities = array();
                 foreach($liveclassroom as $voicetool) {
                     array_push($activities, $voicetool->name);
                 }
                 $xmlResource->WIMBA_setLinkedActivities(implode("|",$activities));
            }
                                    
            $xmlResource->WIMBA_setTooltipAvailability(get_string("tooltipVT_" . $preview . "_student", 'liveclassroom'));
