...
function voicetools_api_create_resource ($resource_data)
{
    ...
    try {
        ...
        wimba_add_log (WIMBA_ERROR, liveclassroom_LOGS, __FUNCTION__ . ' : Error to create the soap element : ' . $e->faultstring);
        return false;
    }
    ...
    try {
        ...
        wimba_add_log (WIMBA_ERROR, liveclassroom_LOGS, __FUNCTION__ . ' : Fault with the web service : ' . $e->faultstring);
        return false;
    }
