...
// Configuration
$string['modulename'] = 'Wimba Classroom';
$string['modulenameplural'] = 'Wimba Classrooms';
$string['serverconfiguration'] = 'Configuration du Serveur Wimba Classroom';
$string['explainserverconfiguration'] = 'Voici la configuration du serveur Wimba Classroom.';
$string['servername'] = 'URL du Serveur';
$string['configservername'] = 'Exemple: http:///myschool.bbbb.net';
...
$string['configsettinguniqueid'] = 'Un prefix unique destin&eacute; &agrave; permettre plusieurs instance de Moodle de partager un Serveur Wimba Classroom sans probl&egrave;me.';
$string['lcversion'] = 'Version du Serveur Wimba Classroom';
...
$string['spacesAdminUsername'] = 'Le nom d\'utilisateur de l\'administrateur contient des espaces';
$string['spacesAdminPassword'] = 'Le mot de passe de l\'administrateur contient des espaces';
...
//Add activity form
$string['name'] = 'Nom';
$string['liveclassroomtype'] = 'Wimba Classroom Associ&eacute;e';
...
$string['liveclassroomtype'] = 'Room associ&eacute;e:';
...
$string['lcpopupshouldappear.1'] = 'La Wimba Classroom devrait maintenant appara&icirc;tre.<br/> Dans le cas contraire, cliquez sur ';
$string['lcpopupshouldappear.2'] = 'ce lien';
$string['lcpopupshouldappear.3'] = ' pour l\'ouvrir. ';

$string['addactivity'] = 'Ajouter une activit&eacute;';
$string['in'] = 'dans';
$string['or'] = 'ou';
$string['new'] = 'Nouveau...';
$string["activity_manageTools"]="G&eacute;rer les Wimba Classrooms";
$string["activity_tools_not_available"]="La Wimba Classroom li&eacute;e &agrave; cette activit&eacute; est actuellement indisponible.<br>Merci de contacter votre professeur";
$string["activity_no_associated_tools"]="Il n'y pas de live classrom associ&eacute;e &agrave; ce cour.<br>Cliquer sur Ok pour en cr&eacute;e une.";
$string["activity_welcome_to_wimba"]="Bienvenue dans la Wimba Classroom!";

//calendar
$string['add_calendar']='Ajouter un &eacute;v&egrave;nement au calendrier';  
$string["launch_calendar"]="Lancer Wimba Classroom";      
...
$string['list_title_pc'] = "Voice Podcaster";
...
$string['error_notfind'] = "Param&egrave;tres de Wimba Classroom invalides. Merci de contacter votre administrateur pour plus d'information.";
$string['error_room'] = "Param&egrave;tres de Wimba Classroom invalides. Merci de contacter votre administrateur pour plus d'information.";
$string['error_connection'] = "Moodle ne peut se connecter å la base de donn&eacute;es. Merci de contacter votre administrateur pour plus d'information.";
$string['error_bd'] =  "Moodle ne peut se connecter å la base de donn&eacute;es. Merci de contacter votre administrateur pour plus d'information.";
...
$string['error_connection_lc'] = "Moodle ne peut se connecter au serveur de Wimba Classroom.. Merci de contacter votre administrateur pour plus d'information.";
$string['error_bdvt'] = "Moodle ne peut se connecter å la base de donn&eacute;es. Merci de contacter votre administrateur pour plus d'information.";
...
$string['error_xml'] = "Problème pour afficher le composant. Merci de contacter votre administrateur pour plus d'information.";
...
$string['choiceElement_description_room'] = "Cr&eacute;er un nouveau Wimba Classroom";
...
$string['general_liveclassroom'] = "Wimba Classroom";
$string['general_pc'] = "Voice Podcaster";
...
$string['settings_enabled_guest_comment'] = "Note : Ce param&egrave;tre n'est effectif que lorsque l'acc&egrave;s public est activ&eacute; sur le serveur de Wimba Classroom .Veuillez contacter votre administrateur pour plus d'informations. ";
...
$string['settings_hms_simulcast_restricted'] = "Autoriser les &eacute;tudiants &agrave; utiliser le t&eacute;l&eacute;phone";
...
$string['settings_video_bandwidth_custom'] = "Custom - pour les utilisateurs avanc&eacute;s";
...
$string['filterbar_lc'] = "Wimba Classrooms";
...
$string['settings_guest_access_comment'] = "Note : Ce param&egrave;tre n'est effectif que lorsque l'acc&egrave;s public est activ&eacute; sur le serveur de Wimba Classroom. Veuillez contacter votre administrateur pour plus d'informations.";
...
$string['tab_tite_boardInfo'] = "Information";
...
$string['tab_title_access'] = "Acc&egrave;s";
$string['tab_title_features'] = "Param&egrave;tres";
$string['list_title_liveclassroom'] = "Wimba Classrooms";
...
$string['configuration_lc'] = "Configuration du Serveur Wimba Classroom";
$string['configuration_lc_server_url'] = "URl du serveur Wimba Classroom:";
$string['configuration_lc_version'] = "Version du serveur Wimba Classroom:";
...
$string['configuration_test_failed_sentence_end'] = "Si le problème persiste, merci de contacter votre administrateur.";
...
$string['configuration_test_lcfailedConnection'] = "Please check the Wimba Classroom parameters and retry.";
$string['configuration_test_lc_failed_sentence_start'] = "The test of your Wimba Classroom server configuration settings was unsuccessful.";
$string['configuration_test_lc_successful_sentence'] = "The test of your Wimba Classroom server configuration settings was successful.
...
$string['advancedPopup_sentence'] = "Vous allez acc&eacute;der aux param&egrave;tres avanc&eacute;s, tous les param&egrave;tres de cette Wimba Classroom vont &ecirc;tre sauv&eacute;s ";
...
$string['list_no_liveclassrooms'] = "Il n'y a pas de Wimba Classroom disponible en ce moment";
...
$string['tooltipLC__student'] = "Disponible pour les &eacute;tudiants";
$string['tooltipLC_1_student'] = "Indisponible pour les &eacute;tudiants";
...
$string['error_connection_lc'] = "Moodle cannot connect to the Wimba Classroom server. Please reload the page or contact your administrator for more information.";
$string['configuration_available_students'] = "Disponible pour les &eacute;tudiants";
$string['settings_advanced_comment_1'] = "Utilisateurs avanc&eacute;s : Cliquer sur le bouton suivant pour ouvrir les options avanc&eacute;es de la Wimba ClassroomClassroom dans une nouvelle fen&ecirc;tre.";
