...
$string['lcversion'] = 'Wimba Classroom Version';
...
$string["wc_logs"]="Wimba Classroom Logs";
...
// capabilities
$string["liveclassroom:addinstance"] = "Add a new Wimba Classroom";
$string["liveclassroom:presenter"] = "Has presenter access to Wimba Classrooms";
//error configuration
$string['emptyAdminUsername'] = 'Admin user name is empty';
$string['emptyAdminPassword'] = 'Admin user password is empty';
$string['spacesAdminUsername'] = 'Admin user name contains space(s)';
$string['spacesAdminPassword'] = 'Admin user password contains space(s)';
...
$string['trailingSlash'] = 'The Wimba Classroom Server Name ends with a trailing \'/\'. Please remove it and submit the configuration again.';
$string['trailingHttp'] = 'The Wimba Classroom Server Name doesn\'t start with \'http://\'. Please add it and submit the configuration again.';
$string['domxml'] = "The php extension Domxml has to be installed to have the Blackboard Collaborate integration working";
$string['httpsnotenabled'] = "https connections are not enabled for this Wimba Classroom server.";
$string['httpsrequired'] = "https connections are required for this Wimba Classroom server.";
...
$string['settings_guest_access_comment1'] = "Note: This setting only has effect when guest access is enabled on the Wimba Classroom server. ";
...
$string["settings_oldArchive"] = "Portable media files cannot be generated from this archive. Archives created in Wimba Classroom prior to version 5.0 are not supported.";
...
$string['error_unconfigured_lc'] = "The Wimba Classroom module has not been configured.  Please contact your administrator.";
...
$string['error_resourcereq'] = 'You must select a resource to associate with this Wimba Classroom';
...
//view panel
$string['lcpopupshouldappear.1'] = 'The Wimba Classroom should now appear.<br> If it does not, please click ';
$string['lcpopupshouldappear.2'] = 'this link';
$string['lcpopupshouldappear.3'] = ' to open it. ';
$string['activity'] = 'activity';
$string['close'] = 'Close';
$string["activity_tools_not_available"]="The Wimba Classroom linked to this activity is currently unavailable.<br>Please contact your instructor";
