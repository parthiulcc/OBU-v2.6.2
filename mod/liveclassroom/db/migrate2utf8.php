...
function WIMBA_migrate2utf8_wiki_name($recordid){
...
function WIMBA_migrate2utf8_wiki_summary($recordid){
    global $CFG, $globallang;
...
function WIMBA_migrate2utf8_wiki_pagename($recordid){
    global $CFG, $globallang;
...
function WIMBA_migrate2utf8_wiki_initialcontent($recordid){
    global $CFG, $globallang;
