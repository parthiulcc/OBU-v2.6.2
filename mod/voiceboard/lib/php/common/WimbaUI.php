    ...
    */    
    function WIMBA_getVTPrincipalView($message,$type=null) {
        ...
        $this->xml->WIMBA_addButtonElement(
                        ...
                        "disabled",
                        "launch",
                        get_string('toolbar_launch', 'voiceboard'),
                        "javascript:WIMBA_LaunchElement('manageAction.php','voiceboard');");
        ...
        if($this->session->WIMBA_isInstructor())
        {
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "disabled",
                            'activities',
                            get_string('toolbar_activity', 'voiceboard'),
                            "WIMBA_doOpenAddActivity('../../course/mod.php','section=0&sesskey=" . sesskey() . "&add=voiceboard')");
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "enabled",
                            "new",
                            get_string('toolbar_new', 'voiceboard'),
                            "javascript:loadNewSettings('generateXmlSettingsPanel.php','create','voicetools' ,'board','all','false')");
            ...
            if(WIMBA_isGradebookAvailable() && isset($type) && $type == "board"){
              $this->xml->WIMBA_addButtonElement(
                              ...
                              "disabled",
                              "grade",
                              get_string('toolbar_grade', 'voiceboard'),
        ...
        if (is_array($resources)) 
        {
            $this->xml->WIMBA_addProduct(
                            ...
                            "board",
                            $resources,
                            get_string('list_no_voiceboards', 'voiceboard'));
        }
        else 
        {//problem to get the vt resource
            wimba_add_log(WIMBA_INFO,voiceboard_LOGS,"No resource have been created yet");  
            $this->xml->WIMBA_setError(get_string("error_connection_vt", "voiceboard"));
        }
    ...
    function WIMBA_getVTSettingsView($update) {
         ...
         *********/
         ...
         {
            $this->xml->WIMBA_addContextBarElement(
                            get_string("contextbar_settings", 'voiceboard'),
                            get_string("general_" . $this->product, 'voiceboard'),
         ...
         else
         {
            $this->xml->WIMBA_addContextBarElement(
                            get_string("contextbar_settings", 'voiceboard'),
                            get_string("general_" . $this->product, 'voiceboard'),
                            get_string("contextbar_new_" . $this->product, 'voiceboard'),
                            "");
         }
        ...
        $this->xml->WIMBA_createValidationButtonElement(
                        get_string("validationElement_cancel", 'voiceboard'),
                        "link",
                        "javascript:launchAjaxRequest('generateXmlMainPanel.php','',true,'all')",
                        "setting_Cancel");
        ...
        {
            $this->xml->WIMBA_createValidationButtonElement(
                            get_string("validationElement_create", 'voiceboard'),
                            "submit",
        ...
        {
            $this->xml->WIMBA_createValidationButtonElement(
                            get_string("validationElement_saveAll", 'voiceboard'),
                            "submit",
...
* ***********************************/
    ...
    */ 
    function WIMBA_createGeneralInfoPanelStart($update) {
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_required", 'voiceboard'));

        $this->xml->WIMBA_createLine();
        
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('description', 'voiceboard'),
                         array ("class" => "LargeLabel_Width TextRegular_Right"));
    ...
    */ 
    function WIMBA_createVBInfoPanel() {
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_thread', 'voiceboard'));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private', 'voiceboard'), 
                        array ("for" => "led_instructor","valign" => "top"));
        $this->xml->WIMBA_addSimpleLineElement("br", NULL);
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_comment', 'voiceboard'), 
                        array ("class" => "TextComment AlignRight"));
        
        $this->xml->WIMBA_createLine();
        
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_Info', 'voiceboard'), 
                        "block", 
                        "Info", 
                        "current", 
                        "all");
    ...
    */ 
    function WIMBA_createVPInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('comment_slide', 'voiceboard'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('private_slide', 'voiceboard'));
        $this->xml->WIMBA_createLine();

        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_slide_comment', 'voiceboard'), 
    ...
    */    
    function WIMBA_createPCInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", 
                                         get_string('post_podcast', 'voiceboard'));
    ...
    */ 
    function WIMBA_createVBVPMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement("label",
                                         get_string('audioquality', 'voiceboard'),
                                         array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_max_message", 'voiceboard'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_media', 'voiceboard'), 
                        "none", 
                        "Media", 
                        "", 
                        "all");
    ...
    */ 
    function WIMBA_createPCMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement(
                        "label",
                        get_string("settings_audio", 'voiceboard'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_auto_publish_podcast", 'voiceboard'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
    ...
    */     
    function WIMBA_createVBFeaturesPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('short_message', 'voiceboard'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('chrono_order', 'voiceboard'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('show_forward', 'voiceboard'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('settings_show_reply', 'voiceboard'));
        ...
        if(WIMBA_isGradebookAvailable()){
          ...
          if(isset ($this->currentObject)){
            $activities = $DB->get_records("voiceboard", array("rid" => $this->currentObject->WIMBA_getRid()));
            if(empty($activities)){
             $parameters['disabled'] = "true";
            }
          }else{
          ...
          $this->xml->WIMBA_addInputElement($parameters);
          $this->xml->WIMBA_addSimpleLineElement("label", get_string('grade_settings', 'voiceboard'));
          
          $this->xml->WIMBA_createLine("Padding_top_25px");
          
          $this->xml->WIMBA_addSimpleLineElement(
                          "label", 
                          get_string('points_possible', 'voiceboard'), 
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_features', 'voiceboard'),
                        "none", 
                        "Features", 
                        "",       
                        "all");
    ...
    */
    function WIMBA_createVTAccessPanel() {
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('available', 'voiceboard'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_date', 'voiceboard'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('end_date', 'voiceboard'), 
                        array ("for" => "end_date"));     
    ...
    */    
    function WIMBA_createOptionAudioSettings() {
        $option = array (
            "value" => "spx_8_q3",
            "display" => get_string('basicquality','voiceboard')
        );
        ...
        $option = array (
            "value" => "spx_16_q4",
            "display" => get_string('standardquality','voiceboard')
        );
        ...
        $option = array (
            "value" => "spx_16_q6",
            "display" => get_string('goodquality','voiceboard')
        );
        ...
        $option = array (
            "value" => "spx_32_q8",
            "display" => get_string('superiorquality','voiceboard')
        );
    ...
    */   
	...
	global $DB;
        $resources = array ();
        $list = voiceboard_get_voicetools_list($this->session->hparams["course_id"]);
        ...
        if( $list != false)
        {
            ...
            {
                wimba_add_log(WIMBA_ERROR,voiceboard_LOGS,"Problem to get the list of resources from the voiceboard_LOGS server"); 
                return false;
            }
            else
        ...
        {
            wimba_add_log(WIMBA_ERROR,voiceboard_LOGS,"Problem to get the list of resources from the databse");   
            return false;    
        }
        ...
        for ($i = 0; $i < count($ressources); $i++) 
        {
            ...
            if ( $voiceboard = $DB->get_records("voiceboard", array("rid" => $rid))) {
                 $activities = array();
            ...
            $xmlResource->WIMBA_setTooltipAvailability(get_string("tooltipVT_" . $preview . "_student", 'voiceboard'));
