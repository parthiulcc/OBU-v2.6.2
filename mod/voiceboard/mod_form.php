...
$PAGE->requires->js('/mod/voiceboard/js/init_calendar_checkbox.js');
...
class mod_voiceboard_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $url_params = voiceboard_WIMBA_get_url_params($COURSE->id);
        ...
        $mform->addElement('select', 'resource', get_string('voiceboardtype', 'voiceboard'), $resopts, array('onchange' => 'LoadNewFeaturePopup(this.options[this.selectedIndex].value);'));
