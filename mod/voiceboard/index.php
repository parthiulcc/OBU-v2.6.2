...
$PAGE->set_url(new moodle_url('/mod/voiceboard/index.php', array('id'=>$COURSE->id)));
...
$PAGE->navbar->add($strvoicetools, new moodle_url('/mod/voiceboard/index.php', array('id'=>$course->id)));
echo $OUTPUT->header();
