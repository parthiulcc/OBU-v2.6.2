...
if (!voicetools_api_isConfigured()) {
    print_error(get_string ('error_unconfigured_vt', 'voiceboard'));
}

if(voiceboard_isView_From_GradeBook() == TRUE){
...
$sentence2="<a href='javascript:WIMBA_startVoiceBoard ()';>".get_string ('vtpopupshouldappear.2', 'voiceboard')."</a>";
