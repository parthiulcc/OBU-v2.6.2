...
if(isset($params["error"]))
{
    wimba_add_log(WIMBA_ERROR,voicepresentation_LOGS,"getXmlListPanel : ". get_string ($params["error"], 'voicepresentation')); 
 	$uiManager->WIMBA_setError( get_string( $params["error"], 'voicepresentation') );
}
  ...
  //Session Management 	
    ...
    { 
        ...
        {
        	$message = get_string( "message_".$messageProduct."_start", "voicepresentation")."  ".
        	           get_string( "message_".$messageAction."_end", "voicepresentation" );
        }
        $uiManager->WIMBA_getVTPrincipalView($message,"presentation"); 
    }
    else
    { //bad session	
