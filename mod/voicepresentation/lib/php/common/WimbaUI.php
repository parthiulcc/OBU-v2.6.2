    ...
    */    
    function WIMBA_getVTPrincipalView($message,$type=null) {
        ...
        $this->xml->WIMBA_addButtonElement(
                        ...
                        "disabled",
                        "launch",
                        get_string('toolbar_launch', 'voicepresentation'),
                        "javascript:WIMBA_LaunchElement('manageAction.php','voicepresentation');");
        ...
        if($this->session->WIMBA_isInstructor())
        {
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "disabled",
                            'activities',
                            get_string('toolbar_activity', 'voicepresentation'),
                            "WIMBA_doOpenAddActivity('../../course/mod.php','section=0&sesskey=" . sesskey() . "&add=voicepresentation')");
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "enabled",
                            "new",
                            get_string('toolbar_new', 'voicepresentation'),
                            "javascript:loadNewSettings('generateXmlSettingsPanel.php','create','voicetools' ,'presentation','all','false')");
            ...
            if(WIMBA_isGradebookAvailable() && isset($type) && $type == "board"){
              $this->xml->WIMBA_addButtonElement(
                              ...
                              "disabled",
                              "grade",
                              get_string('toolbar_grade', 'voicepresentation'),
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "disabled",
                            "settings",
                            get_string('toolbar_settings', 'voicepresentation'),
                            "javascript:WIMBA_editSettings('generateXmlSettingsPanel.php','all');");
            ...
            $this->xml->WIMBA_addButtonElement(
                            ...
                            "disabled",
                            "delete",
                            get_string('toolbar_delete', 'voicepresentation'),
                            "javascript:WIMBA_deleteResource('manageAction.php');");
        ...
        if (is_array($resources)) 
        {
            $this->xml->WIMBA_addProduct(
                            ...
                            "board",
                            $resources,
                            get_string('list_no_voicepresentations', 'voicepresentation'));
        }
        else 
        {//problem to get the vt resource
            wimba_add_log(WIMBA_INFO,voicepresentation_LOGS,"No resource have been created yet");  
            $this->xml->WIMBA_setError(get_string("error_connection_vt", "voicepresentation"));
        }
    ...
    function WIMBA_getVTSettingsView($update) {
         ...
         *********/
         ...
         {
            $this->xml->WIMBA_addContextBarElement(
                            get_string("contextbar_settings", 'voicepresentation'),
                            get_string("general_" . $this->product, 'voicepresentation'),
         ...
         else
         {
            $this->xml->WIMBA_addContextBarElement(
                            get_string("contextbar_settings", 'voicepresentation'),
                            get_string("general_" . $this->product, 'voicepresentation'),
                            get_string("contextbar_new_" . $this->product, 'voicepresentation'),
                            "");
         }
        ...
        $this->xml->WIMBA_createValidationButtonElement(
                        get_string("validationElement_cancel", 'voicepresentation'),
                        "link",
                        "javascript:launchAjaxRequest('generateXmlMainPanel.php','',true,'all')",
                        "setting_Cancel");
        ...
        {
            $this->xml->WIMBA_createValidationButtonElement(
                            get_string("validationElement_create", 'voicepresentation'),
                            "submit",
        ...
        {
            $this->xml->WIMBA_createValidationButtonElement(
                            get_string("validationElement_saveAll", 'voicepresentation'),
                            "submit",
...
* ***********************************/
    ...
    */ 
    function WIMBA_createGeneralInfoPanelStart($update) {
        ...
        $this->xml->WIMBA_addCustomLineElement(
                        "*",
                        "required", 
                        get_string('title', 'voicepresentation'),
                        array ("class" => "LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_required", 'voicepresentation'));

        $this->xml->WIMBA_createLine();
        
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('description', 'voicepresentation'),
                         array ("class" => "LargeLabel_Width TextRegular_Right"));
    ...
    */ 
    function WIMBA_createVBInfoPanel() {
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('type', 'voicepresentation'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('public', 'voicepresentation'), 
                        array ("for" => "led_student","class" => "top"));
        $this->xml->WIMBA_addSimpleLineElement("br", NULL);
        $this->xml->WIMBA_addSimpleLineElement(
                        "span", 
                        get_string('public_comment', 'voicepresentation'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_thread', 'voicepresentation'));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private', 'voicepresentation'), 
                        array ("for" => "led_instructor","valign" => "top"));
        $this->xml->WIMBA_addSimpleLineElement("br", NULL);
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_comment', 'voicepresentation'), 
                        array ("class" => "TextComment AlignRight"));
        
        $this->xml->WIMBA_createLine();
        
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_Info', 'voicepresentation'), 
                        "block", 
                        "Info", 
                        "current", 
                        "all");
    ...
    */ 
    function WIMBA_createVPInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('comment_slide', 'voicepresentation'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('private_slide', 'voicepresentation'));
        $this->xml->WIMBA_createLine();

        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('private_slide_comment', 'voicepresentation'), 
    ...
    */    
    function WIMBA_createPCInfoPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", 
                                         get_string('post_podcast', 'voicepresentation'));
    ...
    */ 
    function WIMBA_createVBVPMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement("label",
                                         get_string('audioquality', 'voicepresentation'),
                                         array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_max_message", 'voicepresentation'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_media', 'voicepresentation'), 
                        "none", 
                        "Media", 
                        "", 
                        "all");
    ...
    */ 
    function WIMBA_createPCMediaPanel() {
        $this->xml->WIMBA_addSimpleLineElement(
                        "label",
                        get_string("settings_audio", 'voicepresentation'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string("settings_auto_publish_podcast", 'voicepresentation'),
                        array("class"=>"LargeLabel_Width TextRegular_Right"));
    ...
    */     
    function WIMBA_createVBFeaturesPanel() {
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('short_message', 'voicepresentation'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('chrono_order', 'voicepresentation'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('show_forward', 'voicepresentation'));
        ...
        $this->xml->WIMBA_addInputElement($parameters);
        $this->xml->WIMBA_addSimpleLineElement("label", get_string('settings_show_reply', 'voicepresentation'));
        ...
        if(WIMBA_isGradebookAvailable()){
          ...
          if(isset ($this->currentObject)){
            $activities = $DB->get_records("voicepresentation", array("rid" => $this->currentObject->WIMBA_getRid()));
            if(empty($activities)){
             $parameters['disabled'] = "true";
            }
          }else{
          ...
          $this->xml->WIMBA_addInputElement($parameters);
          $this->xml->WIMBA_addSimpleLineElement("label", get_string('grade_settings', 'voicepresentation'));
          
          $this->xml->WIMBA_createLine("Padding_top_25px");
          
          $this->xml->WIMBA_addSimpleLineElement(
                          "label", 
                          get_string('points_possible', 'voicepresentation'), 
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('tab_title_features', 'voicepresentation'),
                        "none", 
                        "Features", 
                        "",       
                        "all");
    ...
    */
    function WIMBA_createVTAccessPanel() {
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('available', 'voicepresentation'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('start_date', 'voicepresentation'), 
        ...
        $this->xml->WIMBA_addSimpleLineElement(
                        "label", 
                        get_string('end_date', 'voicepresentation'), 
                        array ("for" => "end_date"));     
        ...
        $this->xml->WIMBA_createPanelSettings(
                        get_string('access', 'voicepresentation'), 
                        "none", 
                        "Access", 
                        "", 
                        "all");
    ...
    */    
    function WIMBA_createOptionAudioSettings() {
        $option = array (
            "value" => "spx_8_q3",
            "display" => get_string('basicquality','voicepresentation')
        );
        ...
        $option = array (
            "value" => "spx_16_q4",
            "display" => get_string('standardquality','voicepresentation')
        );
        ...
        $option = array (
            "value" => "spx_16_q6",
            "display" => get_string('goodquality','voicepresentation')
        );
        ...
        $option = array (
            "value" => "spx_32_q8",
            "display" => get_string('superiorquality','voicepresentation')
        );
    ...
    */   
	...
	global $DB;
        $resources = array ();
        $list = voicepresentation_get_voicetools_list($this->session->hparams["course_id"]);
        ...
        if( $list != false)
        {
            ...
            {
                wimba_add_log(WIMBA_ERROR,voicepresentation_LOGS,"Problem to get the list of resources from the voicepresentation_LOGS server"); 
                return false;
            }
            else
        ...
        {
            wimba_add_log(WIMBA_ERROR,voicepresentation_LOGS,"Problem to get the list of resources from the databse");   
            return false;    
        }
        ...
        for ($i = 0; $i < count($ressources); $i++) 
        {
            ...
            if ( $voicepresentation = $DB->get_records("voicepresentation", array("rid" => $rid))) {
                 $activities = array();
            ...
            $xmlResource->WIMBA_setTooltipAvailability(get_string("tooltipVT_" . $preview . "_student", 'voicepresentation'));
