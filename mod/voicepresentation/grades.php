    ...
    <form name="myform" id="myform" method="post">
        ...
        <div class="headerBar">
         ...
         <div class="contextBar" style="padding-top: 10px; padding-left:10px; height:35px">
            <div style="display: block; float: left;">
                <span style="float: left; width: 130px; font-size: 11px; text-align: right; padding-right: 5px;font-weight: bold;"><?php echo get_string('grade_vb_name', 'voicepresentation');?></span><span><?php echo $resource->WIMBA_getTitle();?></span> <br/> <span style="float: left; width: 130px; font-size: 11px; text-align: right; padding-right: 5px; font-weight: bold;"><?php echo get_string('points_possible', 'voicepresentation');?></span><span>  <?php echo $options->WIMBA_getPointsPossible();?></span>
            </div>
             <div style="float: right;padding-right:15px">
               <input type="button" onclick="javascript:WIMBA_LaunchVoiceTools('manageAction.php','<?php echo $urlParams;?>');" value="<?php echo get_string('grade_open_board', 'voicepresentation');?>"/>
            </div>
        </div>
        ...
        <div class="validationBar" id="validationBar">
        	<ul class="regular_btn_list" style="float: right; padding-top: 2px;">
		        ...
		        <li>
		        	<input type="submit" class="regular_btn-submit" onclick="javascript:WIMBA_submitGradeForm('manageAction.php','submitGrade','<?php echo $urlParams;?>')" value="<?php echo get_string('validationElement_saveAll','voicepresentation');?>"/>
		        </li>
        	</ul>
        </div>
