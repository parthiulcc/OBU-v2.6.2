...
$functions = array (
    ...
    'ombiel_get_user_assignments' => array(
        'classname'   => 'local_ombiel_webservices',
    ...
    'ombiel_get_course_forums' => array(
        'classname'   => 'local_ombiel_webservices',
    ...
    'ombiel_get_choice_options' => array(
        'classname'   => 'local_ombiel_webservices',
    ...
    'ombiel_get_course_assignments' => array(
        'classname'   => 'local_ombiel_webservices',
        'methodname'  => 'get_course_assignments',
        'classpath'   => 'local/ombiel_webservices/externallib.php',
        'description' => 'get my assignments',
        'type'        => 'read',
    ),

    'ombiel_get_course_resources' => array(
        'classname'   => 'local_ombiel_webservices',
    ...
    'ombiel_get_message_settings_link' => array(
        ...
        'classpath'   => 'local/ombiel_webservices/externallib.php',
        'description' => 'get message settings link',
        'type'        => 'read',
    ),
...
$services = array(
    'campusm' => array(
        'functions' => array ('ombiel_get_course_sections',
            ...
            'ombiel_get_course_quizzes',
            'ombiel_get_cm_choice',
            'ombiel_user_choice_response',
            'ombiel_get_choice_options',
            'ombiel_get_cm_page',
            'ombiel_get_user_courses',
            'ombiel_get_coursenews',
            'ombiel_get_course_assignments',
            'ombiel_get_calendar_events',
            'ombiel_get_course_resources',
